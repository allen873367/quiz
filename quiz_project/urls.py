...
urlpatterns = [
    ...
    path('wrong-answers/sr/', views.sr_wrong_answers, name='sr_wrong_answers'),
    path('wrong-answers/<int:record_id>/', views.wrong_answers_detail, name='wrong_answers_detail'),
    path('wrong-answers/sr/<int:record_id>/', views.sr_wrong_answers_detail, name='sr_wrong_answers_detail'),
